...
class _Directory:
    ...
    def __init__(self):
        ...
        """
        # Initialize key variables
        self.root = ('%s/.garnet') % (general.root_directory())
    ...
    def id_agent(self):
        """Method for defining the hidden id_agent directory.
...
class _File:
    ...
    def id_agent(self, prefix):
        ...
        value = ('%s/%s.id_agent') % (self.directory.id_agent(), prefix)
        return value
