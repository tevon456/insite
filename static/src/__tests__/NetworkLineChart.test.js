...
import NetworkLineChart from '../Dashboard/GraphBox/StackedAreaChart/NetworkLineChart.js';

describe('NetworkLineChart', () => {
  test('should match snapshot', () => {
    const networkLineChart = shallow(
  ...
  test('should fetch data from infoset-ng after mount', () => {
    ...
    const component = mount(<NetworkLineChart></NetworkLineChart>);
    server.respond();
    unmount(component);
    })
  });
