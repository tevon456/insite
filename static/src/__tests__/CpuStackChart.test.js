...
import CpuStackChart from '../Dashboard/GraphBox/StackedAreaChart/CpuStackChart.js';

describe('CpuStackChart', () => {
  test('should match snapshot', () => {
    const cpuStackChart = shallow(
      <CpuStackChart></CpuStackChart>
    ); 
  ...
  test('should fetch data from infoset-ng after mount', () => {
    ...
    const component = mount(<CpuStackChart></CpuStackChart>);
    server.respond();
    unmount(component);
    })
  });
