...
class LoadStackChart extends Component {
  ...
  getTicks(data){
    ...
    const ticks = scale.ticks(d3.timeMinute, 5);
    ...
    return(
      <ResponsiveContainer width="100%" height="100%" aspect={2}>
        <AreaChart width={600} height={300} data={this.state.data}
          ...
          <Area type='monotone' dataKey='load_average_01min' stroke='#FDBB5D' fill='#FDBB5D' />
          <Area type='monotone' dataKey='load_average_05min' stroke='#FA9469' fill='#FA9469' />
          <Area type='monotone' dataKey='load_average_15min' stroke='#F37372' fill='#F37372' />
        </AreaChart>
      </ResponsiveContainer>
    )
  }
