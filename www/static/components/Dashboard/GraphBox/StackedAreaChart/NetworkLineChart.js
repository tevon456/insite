...
import { LineChart, Line, Axis, XAxis, YAxis, CartesianGrid, Tooltip} from 'recharts';
    ...
    return(
      <ResponsiveContainer width="100%" height="100%" aspect={2}>
        <LineChart width={600} height={300} data={this.state.data}
          ...
          <Line dot={false} type='monotone' dataKey='network_bytes_recv' stroke='#71d5c3' />
          <Line dot={false} type='monotone' dataKey='network_bytes_sent' stroke='#9771d5' />
        </LineChart>
      </ResponsiveContainer>
    )
  }
